...
imp_temp.show()
imp_temp = ZProjector.run(imp_temp,"max all")
if saturate>0.0:
...
for trackID in trackIDs: 
	...
	stackTrack = ETSA.trackStack3D(trackmate,spot,True,model.getLogger())
	stackTrack.show()
...
#obtain ROIs from track
	...
	#clean up signal outside the ROIs inW all frames of the stack
