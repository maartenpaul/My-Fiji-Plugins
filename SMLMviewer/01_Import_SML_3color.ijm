...
Dialog.addCheckbox("triple color (1 file (ELYRA))",false);
...
triplecolor = Dialog.getCheckbox();
...
print(f,pixel);
print(f, datatype);
if (dualcolor_1 == true&&triplecolor==false){
	print(f, 2);
} else if (dualcolor_1 == true&&triplecolor==true){
		print(f, 3);
}
else {
	print(f, n_channel);	
